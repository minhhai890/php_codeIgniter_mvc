<div id="header">
    <div class="header-top clearfix">
        <div class="social col col8">
            <a href="#" title="Facebook" class="icons"><i class="fab fa-facebook-f"></i>Facebook</a>
            <a href="#" title="Twitter" class="icons"><i class="fab fa-twitter"></i>Twitter</a>
            <a href="#" title="Google" class="icons"><i class="fab fa-google"></i>Google</a>
            <a href="#" title="Instagram" class="icons"><i class="fab fa-instagram"></i>Instagram</a>
            <a href="tel:0932097576" title="Đường dây nóng" class="">Hotline: +84 932 097 576</a>
        </div>
        <div class="classify col col4 clearfix">
            <ul class="clearfix">
                <li class="bt-hover">
                    <a href="javascript:void(0)" title="Việt Nam">Việt Nam <i class="fas fa-angle-down"></i></a>
                    <ul>
                        <li><a href="#" title="" data-lang="vi">Việt Nam</a></li>
                        <li><a href="#" title="" data-lang="en">English</a></li>
                    </ul>
                </li>
                <li class="bt-hover">
                    <a href="javascript:void(0)" title="VNĐ">VNĐ <i class=" fas fa-angle-down"></i></a>
                    <ul>
                        <li><a href="#" title="" data-lang="vi">VNĐ</a></li>
                        <li><a href="#" title="" data-lang="en">USD</a></li>
                    </ul>
                </li>
            </ul>
            ...
            <div class="col col4 center">
                <div>
                    <form action="#" method="get">
                        <input type="text" class="input full" name="keyword" value="" placeholder="Nội dung cần tìm...">
                        <button type="submit"><i class="fas fa-search"></i></button>
                    </form>
                </div>
            </div>
            <div class="col col5 right">
                <div class="classify clearfix">
                    <ul>
                        <li>
                            <a href="#" title="">Thông báo</a>
                            <ul>
                                <li><a href="javascript:void(0)" title>Không có thông báo</a></li>
                            </ul>
                        </li>
                        <li><span>|</span></li>
                        <li>
                            <a href="#" title="">Điểm thưởng</a>
                            <ul>
                                <li><a href="javascript:void(0)" title>Không có thông báo</a></li>
                            </ul>
                        </li>
                        <li><span>|</span></li>
                        <li>
                            <a href="#" title="">Theo dõi đơn hàng</a>
                            <ul>
                                <li><a href="javascript:void(0)" title>Không có thông báo</a></li>
                            </ul>
                        </li>
                ...
                <div class="clearfix">
                    <div class="col col6">
                        <div class="item">
                            <a href="javascript:void(0)" class="viewlogin" title="Đăng nhập/Đăng ký">
                    ...
                    <div class="col col6">
                        <div class="item">
                            <a href="#" title="">
                                ...
                                <strong>Giỏ hàng - <span>0</span></strong>
                            </a>
                        </div>
                    </div>
                </div>
